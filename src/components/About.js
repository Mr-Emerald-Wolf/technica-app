                ...
                <section className="dark:bg-[#10332d] min-h-screen p-2 bg-orange-50">
                    ...
                    <div className="bg-orange-100 dark:bg-[#264d48] p-6 mt-6 m-4 rounded shadow-md ">
                        ...
                        <div className="px-6">
                            ...
                            Shivam Sharma - Leader, Full Stack  {"&"} UI Designer <br />Achintya Gupta - Product Manager  {"&"} Marketing Lead <br /> Devansh Kuldeep Mishra - Content Writer <br />Siddharth Dave - Full Stack <br /> 
                            </p>
